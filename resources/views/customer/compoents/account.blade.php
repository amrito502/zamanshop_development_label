            ...
            <div class="col-lg-3">
                <div class="nav accout-dashborard-nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                    ...
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false"><i class="fa-sharp fa-regular fa-tractor"></i> Track Your Order</button>
                    <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings"
                        aria-selected="false"><i class="fa-sharp fa-regular fa-location-dot"></i>My Address</button>
                    <button class="nav-link" id="v-pills-settingsa-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false"><i class="fa-light fa-user"></i>Account Details</button>
                    <button class="nav-link" id="v-pills-settingsb-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-settingsb" type="button" role="tab" aria-controls="v-pills-settingsb"
                        aria-selected="false"><a href="login.html"><i class="fa-light fa-right-from-bracket"></i>log
                            Out</a></button>
                </div>
            </div>
                        ...
                        <div class="dashboard-account-area">
                            ...
                            <div style="display: flex;justify-content: space-evenly;width: 100%;">
                                @if(auth()->user()->role === 'seller' || auth()->user()->role === 'admin')
                                    <a href="{{ route('seller.dashboard') }}" class="rts-btn btn-primary text-white mr-5 d-block" >Go to Seller
                                        Dashboard</a>
                                @endif
                                @if(auth()->user()->role === 'admin')
                                    <a href="{{ route('admin.dashboard') }}" class="rts-btn btn-primary text-white">Go to Admin
                                        Dashboard</a>
                                @endif
                            </div>
                        </div>
