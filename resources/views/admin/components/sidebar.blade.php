                    ...
                    <ul class="sa-nav__menu sa-nav__menu--root">
                        ...
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <a href="{{ url('/categories') }}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Categories List</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="{{ url('/subcategories') }}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Subcategories List</span>
                                    </a>
                                </li>

                                <li class="sa-nav__menu-item">
                                    <a href="{{ url('/brands') }}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                ...
                                <li class="sa-nav__menu-item">
                                    <a href="" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Product Review List</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Product Slider List</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Product Wishes List</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Product cart List</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="" class="sa-nav__link">
                                ...
                                <li class="sa-nav__menu-item">
                                    <a href="" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Product Invoice</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Polices</span>
                                    </a>
                                </li>
                        ...
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                            <a href="{{ route('admin.seller.requests') }}" class="sa-nav__link">
                                <span class="sa-nav__icon"><i class="fas fa-hdd"></i></span>
                                <span class="sa-nav__title">Seller Request Manage</span>
                            </a>
                        </li>
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
